<template>
    <div class="input-search">
        <div class="input-search-container">
            ...
            <div class="input-label" v-show="!inputSearch">Buscar contatos</div>

            <label for="search">
                <input type="search" id="search" title="Buscar contatos" v-model="inputSearch" @input="handleInput">
            </label>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        handleInput () {
            this.$root.$emit('searchNewChat', this.inputSearch);
        }
    }
};
</script>
