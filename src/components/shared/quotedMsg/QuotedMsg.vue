<template>
    <div class="quoted-msg" :style="{borderColor: color}">
        <div class="box-content">
            <Author :senderObj="quotedMsg.senderObj" :color="color"/>
            <QuotedMsgContent :body="bodyformated" :type="quotedMsg.type" :caption="captionFormated"/>
        </div>

        <div class="box-media">
            <QuotedMedia v-if=" quotedMsg.type !== 'chat' " :body="quotedMsg.body"/>
        </div>
    </div>
</template>
